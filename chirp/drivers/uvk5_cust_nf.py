...
class UVK5RadioNicaF(uvk5.UVK5RadioBase):
    ...
    def k5_approve_firmware(cls, firmware):
        return firmware.startswith('NICA-F ')
    ...
    def set_settings(self, settings):
        ...
        for element in settings:
            ...
            elif elname == "lcd_contrast":
                _mem.lcd_contrast = element.value
...
#                                "in the range %.1f - %.1f" % (FMMIN , FMMAX))
    ...
    def get_settings(self):
        ...
        tmp_contrast = int(_mem.lcd_contrast)
        val = RadioSettingValueInteger(0, 25, tmp_contrast)
        lcd_contrast_setting = RadioSetting("lcd_contrast",
                                        "LCD contrast", val)
...
#
        ...
        dispSubGrp.append(lcd_contrast_setting)
